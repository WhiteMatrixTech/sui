...
You can follow the sample to query a kiosk's contents. 
It's recommended to save the `items` structure (`KioskItem`), as it's useful when you're trying to purchase from one.
